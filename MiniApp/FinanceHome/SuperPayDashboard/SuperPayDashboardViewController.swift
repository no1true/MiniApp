...
final class SuperPayDashboardViewController: UIViewController, SuperPayDashboardPresentable, SuperPayDashboardViewControllable {
    ...
    private func setupViews() {
        ...
        NSLayoutConstraint.activate([
            ...
            cardView.leadingAnchor.constraint(equalTo: headerStackView.leadingAnchor, constant: 20),
            cardView.trailingAnchor.constraint(equalTo: headerStackView.trailingAnchor, constant: -20),
            ...
            balanceAmountLabel.centerYAnchor.constraint(equalTo: cardView.centerYAnchor)
        ])
    }
